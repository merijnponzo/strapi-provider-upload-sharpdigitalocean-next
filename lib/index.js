          ...
          Sharp(file.buffer)
            ...
            .then((buffer) => {
              ...
              S3.upload(params, (err, data) => {
                ...
                console.log('image resized to:' + optimize.size);
                ...
                Sharp(buffer)
                  ...
                  .then((buffer) => {
                    // thumbnail t_
                    var params = {
                      Key: `${settings.awsUploadFolder}/${path}thumbnail_${file.hash}${file.ext}`,
                      Body: Buffer.from(buffer, 'binary'),
                      ACL: 'public-read',
                      ContentType: file.mime,
                      ...customParams,
                    ...
                    S3.upload(params, (err, data) => {
                      ...
                      file.thumbnail = data.Location;
                      console.log(
                        'thumbnail resized to:' + optimize.thumbnail_size
                      );
